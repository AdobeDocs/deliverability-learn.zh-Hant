...
由於DMARC是選用的，因此預設不會在任何ESP平台上設定它。 必須在DNS中為您的網域建立DMARC記錄，它才能運作。 此外，您需要選擇電子郵件地址，以指示DMARC報表應在組織內的哪個位置。 最佳實務是
建議您將DMARC原則從p=none提升至p=quarantine、再提升至p=reject，逐步推出DMARC實作，讓DMARC瞭解DMARC的潛在影響。
...
* [驗證郵件](https://www.valimail.com/products/#automated-delivery)
* [加加里](https://www.agari.com/)
* [Dmarcian](https://dmarcian.com/)
* [校訂](https://www.proofpoint.com/us)
...
| fo | 選填 | 允許網域擁有者指定報告選項。 | 0：如果一切失敗，則產生報告<br/>1：如果一切失敗，則產生報告<br/>d：如果DKIM失敗，則產生報告<br/>s：如果SPF失敗，則產生報告 | 1 （建議用於DMARC報表） |
